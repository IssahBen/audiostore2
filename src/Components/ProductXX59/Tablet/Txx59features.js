export default function Txx59features() {
  return (
    <div className="w-full flex flex-col mediumhide largehide pt-16">
      ...
      <div className="flex  mt-10 items-start w-full space-x-28">
      ...
      <div className="flex  space-x-5 mt-10">
        <div className="flex flex-col space-y-5 w-full">
          <div className="w-full h-[174px] tabletvxx59i1 bg-cover rounded-xl"></div>
          <div className="w-full h-[174px] tabletvxx59i2 bg-cover rounded-xl"></div>
        </div>
        <div className="w-full h-[368px] tabletvxx59i3 bg-cover rounded-xl"></div>
      </div>
    </div>
  );
}
