...
export default function DesktopOptionszx9() {
    ...
    <div className="flex flex-col w-full space-y-10 pt-20 desktophide">
      ...
      <div className="flex w-full space-x-4">
        <div className="flex  flex-col   items-center space-y-4  w-full ">
          <div className="w-full h-[318px] desktopzx7option bg-cover rounded-xl"></div>
        ...
        <div className="flex flex-col w-full  items-center space-y-4">
          <div className="w-full h-[318px] desktopxx59option bg-cover rounded-xl"></div>
          <p className="text-center font-bold manropebh6 tracking-wide">XX59</p>
          <button
            onClick={() => {
